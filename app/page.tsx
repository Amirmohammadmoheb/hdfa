    ...
    <div className="relative">
      ...
      <div className="relative z-10 flex h-screen flex-col items-center my-16">
        ...
        <div className="mt-130 flex justify-center gap-2 flex-wrap">
          <button className="inline-flex items-center opacity-100 justify-center border-white gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 h-11 bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-lg px-8 py-6 rounded-2xl shadow-lg hover:scale-105 transition-transform" style={{backgroundColor:"hsl(45deg 100% 55% / 90%)"}} id="interactButton">🪙 Buy Giggle Token</button>
      ...
      <div className="w-full flex flex-col justify-center items-center absolute mt-110 lg:mt-40">
        ...
        <button className="inline-flex mt-7 items-center justify-center gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 h-11 bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-xl px-12 py-6 rounded-2xl shadow-lg hover:scale-105 transition-transform" style={{backgroundColor:"hsl(45 100% 55%)"}} id="interactButton">🥞 Swap Now on PancakeSwap</button>
